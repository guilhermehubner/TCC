...
\newcommand{\editorial}{Belo Horizonte, p. 01-18, jun. 2016}  % p. xx-xx – páginas inicial-final do artigo
...
\newcommand{\cursA}{Bacharelado em Sistemas de Informação da PUC Minas}

\newcommand{\AutorB}{João Caram Santos de Oliveira Adriano}
\newcommand{\funcaoB}{Professor orientador }
\newcommand{\emailB}{caram@pucminas.br}
\newcommand{\cursB}{Mestre em Ciência da Computação pela Universidade Federal de Minas Gerais}
% 
...
\begin{abstract}
\noindent
O cicloturismo é uma atividade que exige extenso planejamento por parte de seus praticantes, que, sem opções
de ferramentas apropriadas para sua atividade, recorrem a alternativas com propósitos distintos para auxiliá-los em seu planejamento.
Estas ferramentas não oferecem informações suficientes para este perfil de usuário, o que gera uma demanda no meio do cicloturismo por
ferramentas específicas que auxiliem o praticante a planejar suas atividades. Este trabalho 
tem como objetivo o desenvolvimento de uma rede social com o foco em cicloturismo, na qual os usuários podem, a partir 
da interação com o sistema, ter acesso a informações relevantes em relação às rotas que pretendem percorrer, auxiliando 
o planejamento de sua atividade turística. Esta rede social seguiu o modelo centrado em dados. Deste modo os usuários serão responsáveis 
por alimentar a base de dados do sistema de forma colaborativa, sendo possível centralizar informações sobre as rotas. 
\\\textbf{\keyword{Palavras-chave: }} Rede Social, Cicloturismo, \textit{Single Page Application}, Django, AngularJS, RESTful.
\end{abstract}
